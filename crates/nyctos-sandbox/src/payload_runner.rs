...
/// A trimmed copy of `nyctos-nyx::HarnessSpec` so the sandbox crate
...
pub(crate) fn render_synthesised(
    ...
    match lang {
        HarnessLang::Python => out.push_str("# auto-generated by nyctos-sandbox::payload_runner\n"),
        HarnessLang::Shell => {
            out.push_str("#!/bin/sh\n# auto-generated by nyctos-sandbox::payload_runner\nset -u\n")
        }
    }
