...
use nyx_agent_types::agent::{AgentTask, AgentTraceMetrics, AiError, Budget, BudgetKind};
use nyx_agent_types::event::EventSink;
use nyx_agent_types::product::VerifiedVulnerabilityRecord;
...
fn remediation_system_prompt() -> String {
    r#"You are the Nyx Agent local remediation agent.
...
- Do not remove security evidence or Nyx Agent artifacts.
