...
pub use nyx_agent_types::business_logic::BusinessLogicTemplateRunRecord;
pub use nyx_agent_types::product::{
...
mod tests {
    ...
    async fn route_model_roundtrips_for_run() {
        ...
        let rec = RouteModelRecord {
            ...
            model: nyx_agent_types::product::RouteModel {
                backend_routes: vec![nyx_agent_types::product::RouteModelEndpoint {
                    ...
                    confidence: 0.82,
                    evidence: Vec::new(),
                    ..nyx_agent_types::product::RouteModelEndpoint::default()
                }],
                ..nyx_agent_types::product::RouteModel::default()
            },
            created_at: 2_000,
        };
    ...
    async fn signal_candidate_attempt_vulnerability_roundtrip() {
        ...
        assert!(s
            ...
            .get_node_by_ref(
                "run-1",
                nyx_agent_types::attack_graph::NODE_AUTHZ_MATRIX_ENTRY,
                "am-1"
            )
            .await
            .unwrap()
        ...
        assert_eq!(loaded_vuln.risk_score_source, "nyx-agent");
