...
export function WelcomeStep({ form, update }: Props) {
  return (
    <div className="setup-step__body">
      ...
      <p>
        Before the agent will ingest a repository it requires an explicit attestation that you own
        it (or have the owner&rsquo;s permission to scan). Scanning unauthorised systems is illegal
