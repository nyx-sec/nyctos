...
export type RunEvent = { "kind": "Heartbeat", ts: number, } | { "kind": "RunStarted", run_id: string, repos: Array<string>, started_at_ms: number, } | { "kind": "RepoStarted", run_id: string, repo: string, started_at_ms: number, } | { "kind": "RepoStaticDone", run_id: string, repo: string, n_diags: number, elapsed_ms: number, } | { "kind": "RepoDynamicDone", run_id: string, repo: string, elapsed_ms: number, } | { "kind": "RepoFailed", run_id: string, repo: string, message: string, elapsed_ms: number, } | { "kind": "RepoFinished", run_id: string, repo: string, outcome: RepoOutcomeTag, elapsed_ms: number, } | { "kind": "RunFinished", run_id: string, finished_at_ms: number, wall_clock_ms: number, succeeded: number, inconclusive: number, failed: number, };
